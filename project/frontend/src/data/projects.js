...
export const fallbackProjects = [
  ...
  { id: 4, slug: 'university-news', title: '大学新闻网', summary: 'PC 管理端、移动 Web 与微信小程序共享后端 API 的校园新闻系统。', background: '合作项目，覆盖内容管理、多端展示和文件存储。', outcome: '补充个人贡献边界说明，并按团队口径确认公开范围。', role: '个人负责范围待确认；此处仅记录团队项目能力', projectType: '内容平台 / 多端体验', project_type: 'COLLABORATIVE', status: '已授权展示 · 贡献边界待补充', tags: ['合作', '多端', '内容管理'], image: '/assets/v5/nanyang-1.png', visualKind: 'screenshot', evidence: '3 张真实系统截图（由项目成员提供） · 图注与个人贡献边界待确认', gallery: [{ src: '/assets/v5/nanyang-1.png', step: 'STEP 01 / PC 管理端', caption: 'PC 内容管理端。后台以单体服务统一提供新闻内容接口与图片服务，PC 管理端、移动 Web 与微信小程序三端共用同一份内容，不各自维护。' }, { src: '/assets/v5/nanyang-2.png', step: 'STEP 02 / 内容管理', caption: '内容管理环节。新闻内容的日常维护与组织在此完成，改动即时同步到三端。' }, { src: '/assets/v5/nanyang-3.png', step: 'STEP 03 / 多端展示', caption: '同一套内容在移动端与小程序侧的呈现结果。' }] },
]
