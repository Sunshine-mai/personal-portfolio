...
const fallbackProjects = [
  { id: 1, slug: 'ai-translator', title: 'LexiFlow', summary: '面向英语学习者的无广告翻译与生词学习工具，把一次翻译延展为可持续的学习闭环。', background: '翻译、收藏、复习和统计共同组成学习闭环。', outcome: '已实现核心闭环，等待补齐正式发布证据。', role: '产品设计、全栈开发、部署与验证规划', projectType: 'AI 产品 / 学习工具', project_type: 'INDEPENDENT', status: '已实现 · 待补正式发布证据', tags: ['FastAPI', 'Vue 3', '学习闭环'], image: '/assets/v5/translator-home.png', visualKind: 'screenshot', evidence: '2 张已核验截图 · 引擎降级与游客配额的边界证据待补', gallery: [{ src: '/assets/v5/translator-home.png', step: 'STEP 01 / 入口', caption: '首页「每日一词」。把工具的入口前置成每天可以回访的学习动作，而不是一次性的翻译框。' }, { src: '/assets/v5/translator-translate.png', step: 'STEP 02 / 核心链路', caption: '多引擎翻译的真实运行结果：DeepL 与 DeepSeek 双引擎，主引擎不可用时自动降级。截图取自本地实跑，不是设计稿。' }] },
